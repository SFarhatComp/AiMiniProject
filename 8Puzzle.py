...
def Tester(list_of_state, State_to_be_found) -> bool:  # Function Tester is used to make sure that two states are equal
...
def successor_state_generator(current_state, depth_counter=None, succ_dict=None) -> List[List]: #This generator will generate all the children of any given puzzle
